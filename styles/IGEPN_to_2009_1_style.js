...
var style_IGEPN_to_2009_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Mw");
    var labelText = "";
    size = 0;
    ...
    if (value >= 3.000000 && value <= 4.783333) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.783333 && value <= 6.566667) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6.566667 && value <= 8.350000) {
            style = [ new ol.style.Style({
